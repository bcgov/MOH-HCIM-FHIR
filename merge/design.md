# FHIR Design - BC Client Registry FHIR Implementation Guide v1.0.0
...
Two Patient profiles are used: the main profile [ClientRegistryPatient](StructureDefinition-bc-patient.md) - used also the search profile in the search operation (GetDemographics and FindCandidates), the merge profile [MergePatient](StructureDefinition-bc-merge-patient.md).
...
There are several extensions that are applied to the Patient resource. The list below is an overview, more details on the extensions can be found by following the links on the Patient resource snapshot [page](StructureDefinition-bc-patient.md) .
...
| Patient.identifier.system | See the section on[identifiers](identifiers.md) |
...
| | | |
| :--- | :--- | :--- |
| $FindCandidates | [Find Candidates request profile](StructureDefinition-bc-find-candidates-request-bundle.md) | [Find Candidates response profile](StructureDefinition-bc-search-response-bundle.md) |
| $GetDemographics | [Get Demographics request profile](StructureDefinition-bc-get-demographics-request-bundle.md) | [Get Demographics response profile](StructureDefinition-bc-search-response-bundle.md) |
| $RevisePatient | [Revise Patient request profile](StructureDefinition-bc-revise-request-bundle.md) | [Revise Patient response profile](StructureDefinition-bc-revise-response-bundle.md) |
| $RevisePatient.Async | [Revise Patient request profile](StructureDefinition-bc-revise-request-bundle.md) | [Revise Patient response profile](StructureDefinition-bc-revise-response-bundle.md) |
| $AddPatient | [Add Patient request profile](StructureDefinition-bc-add-request-bundle.md) | [Add Patient response profile](StructureDefinition-bc-add-response-bundle.md) |
| $AddPatient.Async | [Add Patient request profile](StructureDefinition-bc-add-request-bundle.md) | [Add Patient response profile](StructureDefinition-bc-add-response-bundle.md) |
...
With History is equivalent to the [$GetDemograhpics with the withHistory parameter](OperationDefinition-bc-patient-get-demographics.md#metadata-in-parameters).

Identifiers Only is equivalent to the [$GetDemographics with the identifiersOnly parameter](OperationDefinition-bc-patient-get-demographics.md#metadata-in-parameters).
...
The table below is only showing the standard parameters included in each Bundle; each Operation may have more parameters such as withHistory. More detailed information regarding each Operation can be found in the [Operation definitions](artifacts.md#operation-definitions).
...
More details can be found here, [Search page](search.md).
...
More details can be found here, [Add, Revise, Update and Merge page](reviseAndMerge.md).
...
See [Patient Notifications](CodeSystem-bc-client-registry-patient-change-notification-events.md) for more details.
