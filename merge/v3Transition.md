# Transition from V3 Provider to FHIR - BC Client Registry FHIR Implementation Guide v1.0.0

* [**Table of Contents**](toc.md)
* **Transition from V3 Provider to FHIR**
...
* providing care to the individual whose information is being accessed; or
