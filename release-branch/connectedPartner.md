# Connected Partners - BC Client Registry FHIR Implementation Guide v1.0.0
...
* Fill out the mandatory **Request for Integrated Services form** and provide to Conformance and Integration Services [link](https://www2.gov.bc.ca/assets/gov/health/forms/4637fil.pdf) Note: MoH may have other requirements for a new Organization that are not detailed here.
...
1. Provincial Client Registry - Onboarding Form
...
1. Provincial Client Registry - Active Integration Guide
...
1. Provincial Client Registry - Quick Start Environments
...
1. Provincial Client Registry - Technical documents
