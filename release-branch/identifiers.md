# Identifiers - BC Client Registry FHIR Implementation Guide v1.0.0
...
The Client Registry makes use of several kinds of identifiers, each requiring different attributes and codes. This page explains, in more detail, the different kinds and how in FHIR they should be represented. This page has PHN, SRI, SSRI, encrypted and encoded PHNs and alternate identifier examples below. The use is supplied in the examples below as it is returned in the response messages, but the use is not required in any of the request message.
...
The ones in the BC-Core project are formated from the V3 Assigning Authority code (source ID or issuer code) following this pattern: https://health.gov.bc.ca/fhir/NamingSystem/ca-bc-_SOURCE_ID_-source-patient-id Example: https://health.gov.bc.ca/fhir/NamingSystem/ca-bc-vpp-cw-source-patient-id , "vpp-cw" is the V3 Assigning Authority code.
