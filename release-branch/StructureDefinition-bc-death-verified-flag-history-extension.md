# BC Death Verified Flag History - BC Client Registry FHIR Implementation Guide v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **BC Death Verified Flag History**

## Extension: BC Death Verified Flag History 

| | |
| :--- | :--- |
| *Official URL*:http://hlth.gov.bc.ca/fhir/client/StructureDefinition/bc-death-verified-flag-history-extension | *Version*:1.0.0 |
| Active as of 2026-01-22 | *Computable Name*:DeathVerifiedFlagHistoryExtension |
...
* Use this Extension: [BC Death Verified Flag](StructureDefinition-bc-death-verified-flag-extension.md)
* Examples for this Extension: [Bundle/GetDemographics-withPHNInfo-Response](Bundle-GetDemographics-withPHNInfo-Response.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fhir.ca-bc.client|current/StructureDefinition/bc-death-verified-flag-history-extension)
...
Other representations of profile: [CSV](StructureDefinition-bc-death-verified-flag-history-extension.csv), [Excel](StructureDefinition-bc-death-verified-flag-history-extension.xlsx), [Schematron](StructureDefinition-bc-death-verified-flag-history-extension.sch) 
