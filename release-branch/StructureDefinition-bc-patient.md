...
| Active as of 2025-11-21 | *Computable Name*:ClientRegistryPatient |
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://hlth.gov.bc.ca/fhir/client/StructureDefinition/bc-birthdate-history-extension"
            ]
          }
        ],
        "mustSupport" : true
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://hlth.gov.bc.ca/fhir/client/StructureDefinition/bc-death-date-history-extension"
            ]
          }
        ],
        "mustSupport" : true
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://hlth.gov.bc.ca/fhir/client/StructureDefinition/bc-multiplebirth-history-extension"
            ]
          }
        ],
        "mustSupport" : true
