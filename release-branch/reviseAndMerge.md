# Add, Revise and Merge Patient - BC Client Registry FHIR Implementation Guide v1.0.0

* [**Table of Contents**](toc.md)
* **Add, Revise and Merge Patient**
...
More details are in the [request Bundle](StructureDefinition-bc-add-request-bundle.md) and [response Bundle](StructureDefinition-bc-add-response-bundle.md) definitions.
...
* Date of Birth
* Gender
* More details are in the [request Bundle](StructureDefinition-bc-revise-request-bundle.md) and [response Bundle](StructureDefinition-bc-revise-response-bundle.md) definitions.
...
More details can be found [here](OperationDefinition-bc-patient-merge.md).
