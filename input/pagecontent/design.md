...
Identifiers Only is equivalent to the [$GetDemographics with the idenifiersOnly parameter](OperationDefinition-bc-patient-get-demographics.html#metadata-in-parameters).
...
Name is equivalent to the combination of both First Name and Surname.
