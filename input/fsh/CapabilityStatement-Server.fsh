...
<p>
The FindCandidates FHIR Operation search SHALL use the following name-value parameters pairs, mandatory or optional according to the cardinality rules below.  This search may return zero or more Patients using the BCPatient profile.  Wildcards are not permitted.
</p>
...
<p>
The GetDemographics FHIR Operation SHALL use the following name-value parameters pairs, mandatory or optional according to the cardinality rules below.  This search may return zero or one Patient using the BCPatient profile.
</p>
<table class=\"grid\">
	<tr>
		<td>
