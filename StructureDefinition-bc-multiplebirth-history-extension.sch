...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'businessDates']) &gt;= 1">extension with URL = 'businessDates': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'businessDates']) &lt;= 1">extension with URL = 'businessDates': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'multipleBirth']) &gt;= 1">extension with URL = 'multipleBirth': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'multipleBirth']) &lt;= 1">extension with URL = 'multipleBirth': maximum cardinality of 'extension' is 1</sch:assert>
